...
const Instruccion = {
    ...
    nuevoImprimirLn: function (_expresion, _linea, _columna) {
        return {
    ...
    nuevaMatriz: function (_tipo1, _tipo2, _id, _tamaño1,_tamaño2, _valores, _expresion1, _linea, _columna) {
        return {
            tipo: TIPO_INSTRUCCION.DECLARACION,
            tipo_dato: TIPO_DATO.MATRIZ,
            id: _id,
            tamaño: _tamaño1, 
            tamaño2: _tamaño2, 
            valores: _valores, 
    ...
    modificacionMatriz: function (_id, _posicion1,_posicion2, _valor, _linea, _columna) {
        return {
            tipo: TIPO_INSTRUCCION.ASIGNACION,
            tipo_dato: TIPO_DATO.MATRIZ,
            id: _id,
            posicion1: _posicion1,
    ...
    accesoMatriz: function (_id, _posicion1,_posicion2, _linea, _columna) {
        return {
            tipo: TIPO_INSTRUCCION.ACCESO,
            tipo_dato: TIPO_DATO.MATRIZ,
            id: _id,
