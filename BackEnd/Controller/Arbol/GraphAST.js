...
class Graph {
    ...
    InstruccionesGrafo(_up, _instruccion) {
        ...
        }else if (_instruccion.tipo === TIPO_INSTRUCCION.PRINTLN) {
                var hijoAST = 'Node' + this.contador;
                this.contador++;
                this.grafo += hijoAST + '[label = \"PRINTLN\"];\n';
                this.grafo += _up + '->' + hijoAST + ';\n';
                this.WriteGrafo(hijoAST, _instruccion);
        }else if (_instruccion.tipo === TIPO_INSTRUCCION.DECLARACION) {
            var hijoAST = 'Node' + this.contador;
            this.contador++;
            this.grafo += hijoAST + '[label = \"DECLARATION\"];\n';
            this.grafo += _up + '->' + hijoAST + ';\n';
    ...
    DeclaracionGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += Identificador1 + '[label = \"IDENTIFIER\"];\n';
        ...
        if (_instruccion.valores != null) {
            ...
            this.contador++;
            this.grafo += valoridentificador + '[label = \"VALUES\"];\n';
    ...
    AsignacionGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += asignarID + '[label = \"IDENTIFIER\"];\n';
    ...
    WhileGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += condicionWhile + '[label = \"CONDITION\"];\n';
        ...
        this.contador++;
        this.grafo += instruccionWhile + '[label = \"INSTRUCTIONS\"];\n';
    ...
    do_WhileGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += doinstuccion2 + '[label = \"INSTRUCTIONS\"];\n';
        ...
        this.contador++;
        this.grafo += dowhilecondicion + '[label = \"CONDITION\"];\n';
    ...
    ForGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += Forcondicion + '[label = \"CONDITION\"];\n';
        ...
        this.contador++;
        this.grafo += foractualizacion + '[label = \"UPDATE\"];\n';
        ...
        this.contador++;
        this.grafo += forinstuccion + '[label = \"INSTRUCTIONS\"];\n';
    ...
    IfElseGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += ifelsecondicion + '[label = \"CONDITION\"];\n';
        ...
        this.contador++;
        this.grafo += ifelseinstuccion + '[label = \"INSTRUCTIONS\"];\n';
        ...
        this.contador++;
        this.grafo += elseinstuccion + '[label = \"INSTRUCTIONS\"];\n';
    ...
    ElseIfGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += elseifcondicion + '[label = \"CONDITION\"];\n';
        ...
        this.contador++;
        this.grafo += elseifinstuccion + '[label = \"INSTRUCTIONS\"];\n';
    ...
    SwitchGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += nintendoSwitch + '[label = \"EVALUATE EXPRESSION\"];\n';
        ...
        if (_instruccion.casosComparar != null) {
            for (let i = 0; i < _instruccion.casosComparar.length; i++) {
                ...
                this.contador++;
                this.grafo += casonintendo + '[label = \"CASE\"];\n';
    ...
    LlamadaGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += llamadadeemergenicababy + '[label = \"NAME\"];\n';
        ...
        if (_instruccion.lista_valores != null) {
            ...
            this.contador++;
            this.grafo += llamadaparametros + '[label = \"PARAMETERS\"];\n';
    ...
    ReturnGrafo(_up, _instruccion) {
        if (_instruccion.expresion) {
            ...
            this.contador++;
            this.grafo += vueltotortillas + '[label = \"EXPRESSION\"];\n';
    ...
    MetodoGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += nombremetodo + '[label = \"NAME\"];\n';
        ...
        if (_instruccion.lista_parametros != null) {
            ...
            this.contador++;
            this.grafo += metodosparametros + '[label = \"PARAMETERS\"];\n';
        ...
        if (_instruccion.instrucciones != null) {
            ...
            this.contador++;
            this.grafo += metodoinstrucciones + '[label = \"INSTRUCTIONS\"];\n';
    ...
    FuncionGrafo(_up, _instruccion) {
        ...
        this.contador++;
        this.grafo += funcionretorno + '[label = \"RETURN TYPE\"];\n';
        ...
        this.contador++;
        this.grafo += funcionnombre + '[label = \"NAME\"];\n';
        ...
        if (_instruccion.lista_parametros != null) {
            ...
            this.contador++;
            this.grafo += funcionparametros + '[label = \"PARAMETERS\"];\n';
        ...
        if (_instruccion.instrucciones != null) {
            ...
            this.contador++;
            this.grafo += funcitoninstrucciones + '[label = \"INSTRUCTIONS\"];\n';
    ...
    OperacionesGrafo(_up, _expresion) {
        ...
        if (_expresion.tipo === TIPO_VALOR.DOBLE || _expresion.tipo === TIPO_VALOR.BOOLEANO || _expresion.tipo === TIPO_VALOR.CADENA || _expresion.tipo === TIPO_VALOR.IDENTIFICADOR || _expresion.tipo === TIPO_VALOR.CARACTER || _expresion.tipo === TIPO_VALOR.ENTERO) {
            ...
            this.contador++;
            this.grafo += ternariocondicion + '[label = \"CONDITION\"];\n';
            ...
            this.contador++;
            this.grafo += expresionternario + '[label = \"EXPRESSION A\"];\n';
            ...
            this.contador++;
            this.grafo += expresionternarioB + '[label = \"EXPRESSION B\"];\n';
            ...
            this.contador++;
            this.grafo += casteoidentidad1 + '[label = \"NEW TYPE\"];\n';
            ...
            this.contador++;
            this.grafo += casteoexpresion + '[label = \"EXPRESSION\"];\n';
            ...
            switch (_expresion.tipo_dato) {
                case TIPO_DATO.VECTOR:
                    ...
                    this.contador++;
                    this.grafo += vectorcito + '[label = \"ARRAY ACCESS\"];\n';
                    this.grafo += _up + '->' + vectorcito + ';\n';
                    var idvectorciot = 'Node' + this.contador;
                    this.contador++;
                    this.grafo += idvectorciot + '[label = \"IDENTIFIER\"];\n';
                    ...
                    this.contador++;
                    this.grafo += posicionvecotrcito + '[label = \"POSITION\"];\n';
                    this.grafo += vectorcito + '->' + posicionvecotrcito + ';\n';
                    this.OperacionesGrafo(posicionvecotrcito, _expresion.posicion);
                    break;
            }
        }else if (_expresion.tipo === TIPO_INSTRUCCION.TO_LOWER || _expresion.tipo === TIPO_INSTRUCCION.TO_UPPER || _expresion.tipo === TIPO_INSTRUCCION.LENGTH  || _expresion.tipo === TIPO_INSTRUCCION.ROUND || _expresion.tipo === TIPO_INSTRUCCION.TYPEOF || _expresion.tipo === TIPO_INSTRUCCION.TOSTRING || _expresion.tipo === TIPO_INSTRUCCION.TOCHARLIST) {
            ...
            this.contador++;
            this.grafo += nativo2 + '[label = \"VALUE\"];\n';
            ...
            this.contador++;
            this.grafo += llamadababydeemergencia + '[label = \"FUNCTION CALL\"];\n';
            this.grafo += _up + '->' + llamadababydeemergencia + ';\n';
            var llamdanombre = 'Node' + this.contador;
            this.contador++;
            this.grafo += llamdanombre + '[label = \"NAME\"];\n';
            ...
            if (_expresion.lista_valores != null) {
                ...
                this.contador++;
                this.grafo += parametrosllamada + '[label = \"PARAMETERS\"];\n';
            ...
            if (_expresion.tipo_dato === TIPO_DATO.DOBLE || _expresion.tipo_dato === TIPO_DATO.BOOLEANO || _expresion.tipo_dato === TIPO_DATO.CADENA || _expresion.tipo_dato === TIPO_DATO.CARACTER || _expresion.tipo_dato === TIPO_DATO.ENTERO || _expresion.tipo_dato.vector || _expresion.tipo_dato.lista) {
                ...
                if (_expresion.id) {
                    ...
                    this.contador++;
                    this.grafo += identificadovector + '[label = \"IDENTIFIER\"];\n';
